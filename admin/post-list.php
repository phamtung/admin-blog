...
<div id = "post">
    <table border="1" cellpadding="0" cellspacing="0" width="100%">
        ...
        <?php
            ...
            $Post = new post();
            $sql = "SELECT * FROM post INNER JOIN title ON post.title_id = title.title_id ORDER BY post_id DESC LIMIT ".$firstRow.",3";
            $Post->query($sql);
        ...
        <?php
            for ( $page = 0; $page <= ($Pagination->totalPage(3) - 1); $page++ ){
                if($page == $_GET['page']){
                    ...
                    echo "<a href='index.php?page_layout=post-list&page=".$page."'>".($page+1)."</a>";
                }
            }
        ?>
    </div>
